...
public class Splasher extends Unit {
    ...
    void play() throws GameActionException {
        ...
        else if (closestRuin != null && numEnemyPaintNearby(closestRuin) >= 8) {
            target = closestRuin;
            retreating = false;
        }
        ...
        if (rc.isActionReady() && rc.getPaint() > 50) {
            ...
            else if (ri.getTeam() == rc.getTeam() && ri.getPaintAmount() > 0) {
    ...
    MapLocation findBestPaintLoc2() throws GameActionException {
        ...
        for (int j=attackPos.length-1; j>=0; j--) {
            ...
            if (lastEnemyTower != null &&
                    m.getMapLocation().isWithinDistanceSquared(lastEnemyTower, 2)) {
                val += 30;
            } else if (closestRuin != null &&
                    m.getMapLocation().isWithinDistanceSquared(closestRuin, 2)) {
                val += 30;
            }
