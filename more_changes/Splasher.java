...
public class Splasher extends Unit {
    ...
    void play() throws GameActionException {
        ...
        else if (target == null) {  // HERE
            int x = rc.getMapWidth()  - home.x + rng.nextInt(-5, 6);
            int y = rc.getMapHeight() - home.y + rng.nextInt(-5, 6);
    ...
    Direction considerMoves() throws GameActionException {
        ...
        for (Direction d : RobotPlayer.directions) {
            ...
            if (rc.canMove(d)) {
                ...
                int val = (int)Math.sqrt(dest.distanceSquaredTo(target)) * -5;  // HERE
                ...
                if (d != Direction.CENTER) {
                    for (int i = 6; i >= 0; i--) {
                        if (dest.equals(lastLocations[i])) {  // HERE
                            val -= 10;
                            break;
                        }
                    }
                ...
                val += 5 * numAllies - numEnemyMoppers - numEnemyTowers * 25;
                if (val > maxVal) {
                    maxVal = val;
                    ret = d;
                }
